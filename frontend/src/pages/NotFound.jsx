      ...
      <div className="max-w-2xl mx-auto text-center space-y-8">
        ...
        >
          ...
          <div className="space-y-4">
            <h1 className="text-8xl lg:text-9xl font-bold text-primary-600">
              404
            </h1>
            ...
            <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-md mx-auto">
              Oops! The page you're looking for seems to have gone on a food
              delivery. Let's get you back to something delicious.
            </p>
          </div>
        </motion.div>
